...
TRAJ_NAME = "mspacman_JE5W3X5P3T_1"
FRAMES = 5169
SECONDS = 87

f = open(os.path.join(os.getcwd(), f'{TRAJ_NAME}/make_video.sh'), 'w')
...
for i in range(1, NUM_FRAMES):
    ...
    #f.write(command)
    command = f'ffmpeg -r 24 -start_number 1 -i {TRAJ_NAME}_%01d.png -c:v libx264 -vf "fps=25,format=yuv420p" -vf "pad=ceil(iw/2)*2:ceil(ih/2)*2" out.mp4'
